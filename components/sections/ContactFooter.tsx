...
export default function ContactFooter() {
  return (
    <footer id="contact" className="py-16 bg-dark-secondary border-t border-gray-800">
        ...
        >
          ...
          <div className="space-y-4 mb-8">
            <p className="text-xl text-gray-300">
              <span className="text-blue-400 font-semibold">Recherche d'Alternance (3 ans)</span>
            </p>
            <p className="text-lg text-gray-400">
              Disponible à partir de <span className="text-blue-300 font-semibold">Septembre 2026</span>
            </p>
            <p className="text-lg text-gray-400">
